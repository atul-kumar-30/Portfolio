        ...
        <div className="contact-content">
          <div className="contact-info">
            ...
            <div className="contact-details">
              <div onClick={() => window.open("https://mail.google.com/mail/?view=cm&fs=1&to=atulk864943@gmail.com", "_blank")} className="contact-item reveal" style={{ textDecoration: 'none', color: 'inherit', cursor: 'pointer' }}>
              ...
              <div onClick={() => window.open("https://github.com/atul-kumar-30", "_blank")} className="contact-item reveal" style={{ textDecoration: 'none', color: 'inherit', cursor: 'pointer' }}>
                <div className="contact-icon">
                  <svg viewBox="0 0 24 24" width="24" height="24">
              ...
              <div onClick={() => window.open("https://www.linkedin.com/in/atul-kumar-805477335/", "_blank")} className="contact-item reveal" style={{ textDecoration: 'none', color: 'inherit', cursor: 'pointer' }}>
                <div className="contact-icon">
                  <svg viewBox="0 0 24 24" width="24" height="24">
