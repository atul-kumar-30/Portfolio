        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <div className="hero-buttons" style={{ marginTop: '2rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '16px', background: 'var(--surface)', border: '1px solid var(--glass-border)', padding: '8px 16px', borderRadius: 'var(--radius)', backdropFilter: 'blur(10px)' }}>
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                  <button onClick={() => window.open('/Atul_Kumar_Resume.pdf', '_blank', 'noreferrer')} className="btn btn--primary" style={{ padding: '8px 16px', fontSize: '0.9rem', minWidth: 'auto' }}>
                    View
                  </button>
                  <button onClick={() => { const a = document.createElement('a'); a.href='/Atul_Kumar_Resume.pdf'; a.download='Atul_Kumar_Resume.pdf'; a.click(); }} className="btn btn--outline" style={{ padding: '8px 16px', fontSize: '0.9rem', minWidth: 'auto' }}>
                    ⬇️ Download
                  </button>
                </div>
              </div>
            ...
            <div className="floating-social" style={{ marginTop: '1.5rem' }}>
              ...
              <span className="social-icon location">
