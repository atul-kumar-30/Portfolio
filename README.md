...
| :--- | :--- |
| ⚛️ **Frontend Framework** | [React.js](https://react.dev/) |
...
| ☁️ **Deployment** | Vercel (with custom `vercel.json` routing configuration) |
...
*   **Scroll Progress Indicator:** A fixed, neon-gradient top progress bar tracking the user's scroll depth (`ScrollProgress.jsx`).
